...
<!--<link rel="stylesheet" href="css/jquery.gritter.css" />-->
    ...
    <script type="text/javascript">   
        ...
        /*
         *根据Userid获取username信息
         *
         */        
        function getUserName(){
         var userid = $('#userid').val();
         $('#makeupCoSe1').empty();
         $('#makeupCoSe1').append("<OPTION id=\"99999\" SELECTED>");
         $.ajax({
				url:"${ctx}/getUserName.do",
				data:{
					"userid" : userid	
					  },
				type:"post",
				...
				success:function(str){
					  ...
					  if(result.state == 0){
						  ...
						  var crmClientids = result.data.crmClientids;
						  $('#userid').val(userid);
		                  $('#customer_name').text(user.userName);
		                  var tl = crmClientids.length;
		                  for(var i=0;i<tl;i++){
		                	 $('#makeupCoSe1').append("<option>"+crmClientids[i].orderId+"</option>");
		                  }		                  
		                  flag = true;			                  
       ...
       function doUpload_drawing(obj){
	     ...
	     function increase_tr(){
		    	 ...
		    	 var tr =  '<tr class="gradeA odd grade-tr">'+
                             ...
                             '<td><input type="text" name="number" onkeyup="numberOnkeyup(this.value)" onKeyPress="numberOnKeyPress(event,this.value)"></td>'+
                             '<td><input type="text" name="number"></td>'+
                             '<td><input type="text" name="number" onkeyup="numberOnkeyup(this.value)" onKeyPress="numberOnKeyPress(event,this.value)"></td>'+
				            ' <td class="center">'+
		...
		function saveClientOrder(){
			...
			if(projectName.trim() == null || projectName.trim() == "" || projectName.trim() == undefined){
				easyDialog.open({
		    		  container : {
		    		    content : '项目名称不能为空'
		    		  },
		...
		function create_clientOrder(){
			...
			window.location = "/supplier/toCreateClientOrder.do";
			
		}
       //返回历史订单
       function back_clientOrder(){
    	   
    	   window.location = "/supplier/queryAllClientOrder.do";
       }
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index-background.html"  class="tip-bottom"><i class="icon  icon-paste"></i>客户订单管理</a> <a href="#" class="current">新建订单</a>
    </div>
   ...
   <input name="selectDrawingName" id="drawing_name" type="hidden"> 
      <div class="shu">
          <div class="bianhaolan">
              <div class="fapiao">
                  <label>客户ID :</label>
                  <input type="text" id="userid"  name="userid" value="" placeholder="" onBlur="getUserName()">
              </div>
              <p class="bianhao">
    ...
    <div class="container-fluid"><hr style="clear:both;">
        ...
        <div class="control-group w-control-group">
            ...
            <div class="controls">
                <input type="text" name="projectName" id="project_name" value="">
            </div>
        </div>
        <div class="control-group w-control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="createTime" value="<%=DateFormat.currentDate()%>" id="date_input1" data-date="2016-01-02" data-date-format="dd-mm-yyyy" placeholder="2016-01-01" onclick="WdatePicker({skin:'whyGreen',lang:'en',dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})">
            </div>
        </div>
 </div>
                        ...
                        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                            <table class="table table-bordered data-table dataTable" id="DataTables_Table_0">
                                ...
                                <tr class="gradeA odd grade-tr">
                                    ...
                                    <td class="center">
                                        <div class="uploader">
                                          <input type="file" id="file_upload_drawing" name="file_upload_drawing" size="19" style="opacity: 0;" onChange="doUpload_drawing(this)"><span class="filename" id="file_input1">No file selected</span><span class="action">Choose File</span>   
                                          <input value="" type="hidden">            
                                        </div>
                                    </td>
                                </tr>
                                <tr class="gradeA odd grade-tr">
                                    ...
                                    <td class="center">
                                        <select class="xiala_select" name="select">
                                            ...
                                            <div class="uploader div-uploader" style="background-image: url(img/sprite2.png);">
                                                <input type="file" id="file_upload_drawing" name="file_upload_drawing" size="19" style="opacity: 0;" onChange="doUpload_drawing(this)">
                                                <span class="filename" style="width: 50px;">No file selected</span>
                                                <span class="action" style="width: 50px;background-color: transparent;">Choose</span>
                                                <input value="" type="hidden">
                                            </div>
                                            <a href="#"><button class="btn btn-danger btn-div" onclick="removeDrawing1(this)">删除</button></a>
                                    </td>
                                </tr>
                                <tr class="gradeA odd grade-tr">
                                    <td><input type="text" name="number"></td>
                                    ...
                                    <td class="center">
                                        ...
                                        <div class="uploader div-uploader" style="background-image: url(img/sprite2.png);">
                                            <input type="file" size="19" id="file_upload_drawing" name="file_upload_drawing" style="opacity: 0;" onChange="doUpload_drawing(this)">
                                            <span class="filename" style="width: 50px;">No file selected</span>
                                            <span class="action" style="width: 50px;background-color: transparent;">Choose</span>
                                            <input value="" type="hidden">
                                        </div>
    ...
    <div class="container-fluid"><hr style="clear:both;">
	    ...
	    <input name="poPath" id="upload_po_path"  type="hidden">
