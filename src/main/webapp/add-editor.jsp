...
<script type="text/javascript">
    ...
    $(function(){
       ...
       $('#sidebar').find('li').eq(2).addClass('active');
   	   ...
   	   var user_permission = $('#current_permission').val();
   	   $("#permission").find("option[value='"+user_permission+"']").attr("selected",true);
	...
	function submitForm(id) {
		...
		if (userName == null || userName == "" || pwd == null || pwd == "" || permission == null || permission == "") {
			...
			$.ajax({
				type : "post",
				datatype : "json",
				url : "/supplier/backUser/updateBackUser.do",
				data : {
					"id" : id,
					"userId" : userId,
					"userName" : userName,
...
<body>
	...
	<div id="content">
		<div id="content-header">
			...
			<h1 style="font-size: 26px;">编辑用户</h1>
		</div>
									...
									<div class="control-group" style="display: none;">
										...
										<div class="controls">
											<input id="userId" type="text" name="userId"
												value="${userInfo.backUserid}" class="ui-wizard-content">
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input id="userName" type="text" name="userName"
												value="${userInfo.userName}" class="ui-wizard-content" onBlur="checkUserName()">
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input id="realName" type="text" name="realName"
												value="${userInfo.realName}" class="ui-wizard-content">
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input id="pwd" type="password" name="pwd"
												value="${userInfo.pwd}" class="ui-wizard-content">
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input id="email" type="text" name="email"
												value="${userInfo.email}" class="ui-wizard-content">
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input id="tel" type="text" name="tel"
												value="${userInfo.tel}" class="ui-wizard-content">
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">用户权限</label>
										<div class="controls">
										    <input type="hidden" id="current_permission" value="${userInfo.permission}"/>
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea id="remark" name="remark"
												style="height: 72px; width: 50%;">${userInfo.remark}</textarea>
										</div>
									</div>
<!-- 									<div class="control-group" style="display: none;"> -->
<!-- 										<label class="control-label">Update User</label> -->
<!-- 										<div class="controls"> -->
<!-- 											<input id="updateUser" type="text" name="updateUser" -->
<%-- 												value="${userInfo.userName}" class="ui-wizard-content"> --%>
<!-- 										</div> -->
<!-- 									</div> -->
								...
								<div class="form-actions">
									...
									<button class="btn btn-success" onclick="submitForm('${userInfo.id}')">Save</button>
								</div>
