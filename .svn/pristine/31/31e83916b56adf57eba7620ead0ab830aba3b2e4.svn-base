...
// 		  var path =  $("#invoice_invoicePath").val();
// 		  if(path != null || path != ""){			  
// 			  sppath = path.split("\\");
...
// 		  }		  
// 		  var transactionType = $('#invoice_transactionType').val();
// 		  $('#transactionType').val(transactionType);
		  var bank = $('#invoice_bank').val();		  
	...
	function saveBankInfo(invoiceId) {
		...
		$.post("/supplier/updateInvoiceInfo.do", {
			...
			"paymentTime6" : paymentTime6
              ...
              *同步invoice到ERP
              */
			  $.post("/supplier/port/invoiceToERPSYNC.do",
                     { 
       			   "orderId" : orderId,
       			   "invoiceId" : invoiceId
       			   },
...
<%-- 				<input id="invoice_transactionType" value="${invoiceInfo.transactionType}" type="hidden"> --%>
<%-- 				<input id="invoice_invoicePath" value="${invoiceInfo.invoicePath}" type="hidden"> --%>
<%-- 				<input id="invoice_bank" value="${bank}" type="hidden"> --%>
<!-- 					<div class="controls"> -->
...
<!-- 			</div> -->
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<h1 style="font-size: 16px; margin: 0;">到款计划</h1>
				...
				<div>
					<div class="control-group" style="width: 40%; float: left;">
						...
						<div class="controls">
							<input type="text" name="required" id="amount_input1" onkeyup="keyUp(this)" onKeyPress="keyPress(this)" onblur="onBlur(this)" value="${amount1}"/>
						</div>
					</div>
