  ...
  <div id="content-header">
   ...
   <input name="selectDrawingName" id="drawing_name" type="hidden"> 
    ...
    <div class="container-fluid"><hr style="clear:both;">
       ...
       <script language="javascript">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="createTime" value="${reOrder.createTime}" id="date_input1" data-date="2016-01-02" data-date-format="dd-mm-yyyy" placeholder="<%=DateFormat.currentDate()%>" onclick="WdatePicker({skin:'whyGreen',lang:'en',dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})">
            </div>
        </div>
 </div>
                        ...
                        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                            <table class="table table-bordered data-table dataTable" id="DataTables_Table_0">
                                ...
                                <tr class="gradeA odd grade-tr">
                                    <td><input type="text" name="number" value="${obj.productName}"></td>
                                    <td><input type="text" name="number" value="${obj.unitPrice}" onkeyup="keyUp(this)" onKeyPress="keyPress(this)" onblur="onBlur(this)"/></td>
                                    <td><input type="text" name="number" value="${obj.quantity}" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"></td>
                                    <td><input type="text" name="number" value="${obj.moldPrice}" onkeyup="keyUp(this)" onKeyPress="keyPress(this)" onblur="onBlur(this)"/></td>
                                    <td class="center">
                                        <select class="xiala_select" name="select">
                                              <option value="0"></option>
                                            </select>
                                            <div class="uploader" style="background-image: url(img/sprite2.png);">
                                                <input type="file" id="file_upload_drawing" name="file_upload_drawing" size="19" style="opacity: 0;" onChange="doUpload_drawing(this)">
                                                <span class="filename" style="width: 50px;">${obj.drawingsName}</span>
                                                <span class="action" style="width: 50px;background-color: transparent;">Choose</span>
                                                <input value="${obj.drawingsName}" type="hidden">
                                            </div>
                                           <a href="#"><button class="btn btn-danger" onclick="removeDrawing(this)">删除</button></a>
                                    </td>
                                </tr>
    ...
    <div class="container-fluid"><hr style="clear:both;">
	    ...
	    <input name="reOrderId" id="reOrderId" value="${reOrder.id}" type="hidden">
        <div class="control-group">
